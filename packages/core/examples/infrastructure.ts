...
const environmentPermissions = defineRule(
    ...
    async (input) => {
        ...
        const userRole = input.userId.includes("admin")
            ? "admin"
            : input.userId.includes("devops")
              ? "devops"
              : input.userId.includes("qa")
                ? "qa"
                : "developer";
 ...
 */
const costLimitCheck = defineRule(infrastructureContext, "cost-limit-check", async (input) => {
 ...
 */
const deploymentWindow = defineRule(infrastructureContext, "deployment-window", async (input) => {
 ...
 */
const scalingLimits = defineRule(infrastructureContext, "scaling-limits", async (input) => {
