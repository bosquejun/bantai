 ...
 */
const nameLengthCheck = defineRule(nameValidationContext, "name-length-check", async (input) => {
 ...
 */
const nameFormatCheck = defineRule(nameValidationContext, "name-format-check", async (input) => {
    const violations: string[] = [];
 ...
 */
const profanityCheck = defineRule(nameValidationContext, "profanity-check", async (input) => {
    const violations: string[] = [];
