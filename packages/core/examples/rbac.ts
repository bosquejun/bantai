 ...
 */
const roleCheck = defineRule(rbacContext, "role-check", async (input) => {
 ...
 */
const permissionCheck = defineRule(rbacContext, "permission-check", async (input) => {
 ...
 */
const resourceOwnership = defineRule(rbacContext, "resource-ownership", async (input) => {
 ...
 */
const actionRestriction = defineRule(rbacContext, "action-restriction", async (input) => {
