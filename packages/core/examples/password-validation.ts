 ...
 */
const lengthCheck = defineRule(passwordValidationContext, "length-check", async (input) => {
 ...
 */
const complexityCheck = defineRule(passwordValidationContext, "complexity-check", async (input) => {
 ...
 */
const patternCheck = defineRule(passwordValidationContext, "pattern-check", async (input) => {
    const password = input.password;
...
const passwordValidationPolicy = definePolicy(
    ...
    [lengthCheck, complexityCheck, commonPasswordCheck, passwordReuseCheck, patternCheck],
    {
...
async function runExamples() {
    ...
    const result5 = await evaluatePolicy(passwordValidationPolicy, {
        password: "MyStr0ng!P@ssw0rd",
        userId: "user123",
        previousPasswords: ["MyStr0ng!P@ssw0rd", "OldP@ssw0rd123", "Previous1!Pass"],
    });
