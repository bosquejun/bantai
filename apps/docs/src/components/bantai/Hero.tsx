        ...
        <div className="w-full max-w-6xl mx-auto relative mt-32 px-4 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch gap-8 lg:gap-0">
                ...
                <div className="lg:col-span-3 flex flex-col justify-center gap-4">
                    <div className="text-[9px] font-mono dark:text-white/30 text-black/30 uppercase tracking-[0.3em] mb-2">
                        Real-world Inputs
                    </div>
                    ...
                    <div className="p-4 border dark:border-white/10 border-black/10 dark:bg-white/5 bg-black/5 space-y-1 relative overflow-hidden group dark:hover:border-white/30 hover:border-black/30 transition-colors">
                        ...
                        <div className="text-[10px] font-black dark:text-white/60 text-black/60 uppercase">
                            User Context
                        </div>
                        <div className="text-[9px] font-mono dark:text-white/40 text-black/40 italic">
                            {'{ role: "editor", age: 25 }'}
                        </div>
                    ...
                    <div className="mt-4 flex gap-3 grayscale opacity-30 justify-start lg:justify-start">
                        ...
                        />
                        <img
                            src="https://simpleicons.org/icons/cloudflareworkers.svg"
                            className="w-4 h-4 invert"
                            alt="Workers"
                        />
                    </div>
                ...
                <div className="hidden lg:block lg:col-span-1 relative">
                    <svg className="w-full h-full" viewBox="0 0 100 400" preserveAspectRatio="none">
                        <path
                            d="M 0 100 Q 50 100 100 200"
                            fill="none"
                            stroke="currentColor"
                            strokeWidth="1"
                            strokeDasharray="4 4"
                            className="dark:text-white text-black opacity-10 animate-dash-flow"
                        />
                        <path
                            d="M 0 200 Q 50 200 100 200"
                            fill="none"
                            stroke="currentColor"
                            strokeWidth="1"
                            strokeDasharray="4 4"
                        ...
                        <div className="relative border-2 dark:border-white/10 border-black/10 dark:bg-black bg-white p-8 shadow-2xl">
                            <div className="flex items-center justify-between mb-8">
                                <div className="flex items-center justify-center w-full gap-3">
                                    ...
                                    <span className="text-[12px] font-black dark:text-white text-black tracking-[0.2em] uppercase">
                                        BANTAI
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                <div className="border dark:border-white/20 border-black/20 px-3 py-2 text-[10px] font-black uppercase flex items-center justify-between dark:bg-white/5 bg-black/5 relative overflow-hidden group/item">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-[8px] dark:text-white/40 text-black/40">
                                            Validated
                                        </span>
                                    </div>
                                </div>
                                <div className="border dark:border-white/20 border-black/20 px-3 py-2 text-[10px] font-black uppercase flex items-center justify-between dark:bg-white/5 bg-black/5 relative overflow-hidden group/item">
                                    ...
                                    <span className="text-[8px] dark:text-white/40 text-black/40 italic">
                                        Composable
                                    </span>
                                </div>
                                <div className="border dark:border-white/20 border-black/20 px-3 py-2 text-[10px] font-black uppercase flex items-center justify-between dark:bg-white/5 bg-black/5 relative overflow-hidden group/item">
                            ...
                            <div className="mt-8 pt-6 border-t dark:border-white/10 border-black/10 flex justify-between items-center">
                                <span className="text-[9px] font-mono dark:text-white/30 text-black/30 tracking-[0.2em] uppercase">
                                    Evaluating...
                                </span>
                ...
                <div className="lg:col-span-3 flex flex-col justify-center gap-6">
                    <div className="text-[9px] font-mono dark:text-white/30 text-black/30 uppercase tracking-[0.3em] mb-2 text-center">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative border-2 border-green-500 bg-green-500/10 p-6 flex flex-col items-center text-center transition-all group-hover:bg-green-500/20">
                            <div className="text-green-500 font-black text-3xl tracking-tighter uppercase mb-2">
                                ALLOW
                            </div>
                            <div className="w-full h-px bg-green-500/20 my-4"></div>
                            <div className="text-[10px] font-bold text-green-500/60 uppercase tracking-widest mb-1">
                                Status: OK
                            </div>
                            <div className="text-[10px] font-bold text-green-500 uppercase tracking-tight leading-tight">
                    ...
                    <div className="relative grayscale opacity-40 blur-[0.5px] hover:grayscale-0 hover:opacity-100 hover:blur-0 transition-all">
                        <div className="border border-[#f87171]/40 bg-[#f87171]/5 p-4 flex flex-col items-center text-center">
                            <div className="text-[#f87171] font-black text-xl tracking-tighter uppercase mb-1">
                                DENY
                            </div>
                            <div className="text-[9px] font-bold dark:text-white/40 text-black/40 uppercase tracking-widest italic">
            ...
            <div className="relative max-w-[1400px] mx-auto px-6 sm:px-12">
                <div className="flex flex-col items-center text-center">
                    <div className="inline-flex items-center border px-3 py-1 mb-12 relative overflow-hidden bg-background">
                        <span className="text-[9px] font-mono font-bold uppercase tracking-[0.4em] text-foreground/60">
                    ...
                    <div className="w-full max-w-2xl border-t border-input pt-8 mb-20">
                        <p className="text-xl lg:text-2xl text-foreground/60 leading-tight font-medium uppercase tracking-tighter font-heading">
                            Bantai evaluates real-world inputs into{" "}
                            <span className="text-foreground">
                                deterministic, explainable allow/deny decisions
                            </span>{" "}
                            with full TypeScript safety.
                        </p>
                    </div>
