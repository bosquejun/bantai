            ...
            <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-24">
                    <div className="max-w-xs">
                        <div className="flex items-center space-x-2 group cursor-pointer mb-4">
                            ...
                            <div className="flex flex-col">
                                <span className="text-lg font-black tracking-[0.3em] dark:text-white text-black uppercase leading-none">
                                    BANTAI
                                </span>
                            </div>
                        </div>
                        <p className="text-[10px] text-foreground/40 font-bold leading-relaxed uppercase tracking-tight mb-8">
                            TypeScript-first policy evaluation library for rule-based validation and
                            decision-making
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-16 md:gap-24">
                        <div className="flex flex-col space-y-2">
                            <span className="text-[10px] font-black text-foreground uppercase tracking-[0.4em] mb-2">
                                ENGINE
                            </span>
                            ...
                            <Link
                                href="/docs"
                                className="text-[10px] font-bold text-foreground/40 hover:text-foreground transition-colors uppercase tracking-widest"
                            >
                                GETTING STARTED
                            </Link>
                            <Link
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <span className="text-[10px] font-bold text-foreground/20 uppercase tracking-widest cursor-default">
                                MIT LICENSE
                            </span>
                            <span className="text-[10px] font-bold text-foreground/20 uppercase tracking-widest cursor-default">
                                CODE OF CONDUCT
                ...
                <div className="mt-40 pt-12 border-t border-input flex flex-col sm:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex space-x-12 text-[9px] font-black text-foreground/20 tracking-[0.4em] uppercase">
                        <a
                            href="https://www.npmjs.com/package/@bantai-dev/core"
                            target="_blank"
