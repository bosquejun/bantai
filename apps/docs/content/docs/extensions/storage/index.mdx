...
description: Add storage capabilities to your Bantai contexts
---
...
- **[Rate Limiting Extension](/docs/extensions/with-rate-limit)** - Uses storage for rate limit counters
- **[Redis Storage](/docs/extensions/storage-redis)** - Production-ready Redis storage adapter
