...
import type { SimulationStore } from "../types/simulationStore.types";
...
export const useSimulationStore = create<SimulationStore>()(
    persist(
        (set, get) => ({
            ...
            runSimulation: () => {
                const { simulationInput, simulationInputErrors } = get();
                const workspaceStore = useWorkspaceStore.getState();
                const { activeWorkspaceId, workspaces } = workspaceStore;
                ...
                setTimeout(() => {
                    ...
                    try {
                        ...
                        workspace.rules.forEach((rule, idx) => {
                            if (!rule.enabled) {
                                trace.push({
                                    id: `r-${idx}`,
                        ...
                        workspace.policies.forEach((policy, idx) => {
        ...
        {
            name: "bantai-simulation-storage",
