/**
 * Legacy store implementation - kept for backward compatibility during migration
...
/**
 * @deprecated Use useCurrentWorkspace from '@/shared/store' instead
 */
...
/**
 * @deprecated Use domain-specific stores instead:
 * - useWorkspaceStore() for workspace management
 * - useGlobalStore() for theme
 * - useSimulationStore() for simulation
 * - usePackagesStore() for packages
 * - useRulesStore() for rules operations
 * - usePoliciesStore() for policies operations
 */
